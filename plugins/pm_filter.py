...
async def next_page(bot, query):
    ...
    btn.insert(0,
        [ 
	    InlineKeyboardButton(text="⚡ʜᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ⚡", url='https://t.me/moviemasala_download'),
        ] 
    )
...
async def filter_languages_cb_handler(client: Client, query: CallbackQuery):
    try:
        ...
        curr_time = datetime.now(pytz.timezone('Asia/Kathmandu')).time()
        search = FRESH.get(key)
        search = search.replace("_", " ")
        baal = lang in search
        if baal:
...
async def cb_handler(client: Client, query: CallbackQuery):
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if grpid is not None:
                ...
                try:
                    ...
                    return await query.answer('♥️ Love @MovieMasala_Update ♥️')
            else:
                await query.message.edit_text(
                    "I'm not connected to any groups!\nCheck /connections or connect to any groups",
                    quote=True
                )
                return await query.answer('♥️ Thank You MovieMasala ♥️')
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🔔 Updates 🤖', url='https://t.me/MovieMasala_Update')
        ], [
            ...
            InlineKeyboardButton('⪦ YOUTUBE ⪧', url='https://youtube.com/@moviemasala_bot')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        await query.answer('♥️ Thank You MovieMasala ♥️')
        ...
        await query.answer("Thank You MovieMasala")
        ...
        try:
            btn = [[
                ...
                InlineKeyboardButton(text=f"🐞 REPORT BUG 🐞", url=f"https://t.me/+-4k4ZoF-NQVkMmJl")
            ],[
                InlineKeyboardButton(text=f"⚡️ YOUTUBE 🦋", url=f"https://youtube.com/@moviemasala_bot")
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0,
        [ 
	    InlineKeyboardButton(text="⚡ʜᴏᴡ to ᴅᴏᴡɴʟᴏᴀᴅ⚡", url='https://t.me/moviemasala_download'),
        ] 
    )
